...
H = (Material("H", 8.3748e-05),)
He = (Material("He", 0.000166322),)
Li = (Material("Li", 0.534),)
Be = (Material("Be", 1.848),)
B = (Material("B", 2.37),)
C = (Material("C", 2),)
N = (Material("N", 0.0011652),)
O = (Material("O", 0.00133151),)
F = (Material("F", 0.00158029),)
Ne = (Material("Ne", 0.000838505),)
Na = (Material("Na", 0.971),)
Mg = (Material("Mg", 1.74),)
Al = (Material("Al", 2.699),)
Si = (Material("Si", 2.33),)
P = (Material("P", 2.2),)
S = (Material("S", 2),)
Cl = (Material("Cl", 0.00299473),)
Ar = (Material("Ar", 0.00166201),)
K = (Material("K", 0.862),)
Ca = (Material("Ca", 1.55),)
Sc = (Material("Sc", 2.989),)
Ti = (Material("Ti", 4.54),)
V = (Material("V", 6.11),)
Cr = (Material("Cr", 7.18),)
Mn = (Material("Mn", 7.44),)
...
Co = (Material("Co", 8.9),)
Ni = (Material("Ni", 8.902),)
Cu = (Material("Cu", 8.96),)
Zn = (Material("Zn", 7.133),)
Ga = (Material("Ga", 5.904),)
Ge = (Material("Ge", 5.323),)
As = (Material("As", 5.73),)
Se = (Material("Se", 4.5),)
Br = (Material("Br", 0.0070721),)
Kr = (Material("Kr", 0.00347832),)
Rb = (Material("Rb", 1.532),)
Sr = (Material("Sr", 2.54),)
Y = (Material("Y", 4.469),)
Zr = (Material("Zr", 6.506),)
Nb = (Material("Nb", 8.57),)
Mo = (Material("Mo", 10.22),)
Tc = (Material("Tc", 11.5),)
Ru = (Material("Ru", 12.41),)
Rh = (Material("Rh", 12.41),)
Pd = (Material("Pd", 12.02),)
Ag = (Material("Ag", 10.5),)
Cd = (Material("Cd", 8.65),)
In = (Material("In", 7.31),)
Sn = (Material("Sn", 7.31),)
Sb = (Material("Sb", 6.691),)
Te = (Material("Te", 6.24),)
I = (Material("I", 4.93),)
Xe = (Material("Xe", 0.00548536),)
Cs = (Material("Cs", 1.873),)
Ba = (Material("Ba", 3.5),)
La = (Material("La", 6.154),)
Ce = (Material("Ce", 6.657),)
Pr = (Material("Pr", 6.71),)
Nd = (Material("Nd", 6.9),)
Pm = (Material("Pm", 7.22),)
Sm = (Material("Sm", 7.46),)
Eu = (Material("Eu", 5.243),)
Gd = (Material("Gd", 7.9004),)
Tb = (Material("Tb", 8.229),)
Dy = (Material("Dy", 8.55),)
Ho = (Material("Ho", 8.795),)
Er = (Material("Er", 9.066),)
Tm = (Material("Tm", 9.321),)
Yb = (Material("Yb", 6.73),)
Lu = (Material("Lu", 9.84),)
Hf = (Material("Hf", 13.31),)
Ta = (Material("Ta", 16.654),)
W = (Material("W", 19.3),)
Re = (Material("Re", 21.02),)
Os = (Material("Os", 22.57),)
Ir = (Material("Ir", 22.42),)
Pt = (Material("Pt", 21.45),)
Au = (Material("Au", 19.32),)
Hg = (Material("Hg", 13.546),)
Tl = (Material("Tl", 11.72),)
Pb = (Material("Pb", 11.35),)
Bi = (Material("Bi", 9.747),)
Po = (Material("Po", 9.32),)
At = (Material("At", 9.32),)
Rn = (Material("Rn", 0.00900662),)
Fr = (Material("Fr", 1),)
Ra = (Material("Ra", 5),)
Ac = (Material("Ac", 10.07),)
Th = (Material("Th", 11.72),)
Pa = (Material("Pa", 15.37),)
U = (Material("U", 18.95),)
Np = (Material("Np", 20.25),)
Pu = (Material("Pu", 19.84),)
Am = (Material("Am", 13.67),)
Cm = (Material("Cm", 13.51),)
Bk = (Material("Bk", 14),)
Cf = (Material("Cf", 10),)
